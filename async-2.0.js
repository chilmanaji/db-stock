var url = "https://apps.debusana.com/api/stock?code="+code;
...
function callback(data){
	...
	for(var i=0; i < obj.stocks.length; i++){
		text += '<div class=\"stock-list\"><span>'+obj.stocks[i].name+"</span>  <span class=\"badge\">"+obj.stocks[i].quantity+"</span></div>";
